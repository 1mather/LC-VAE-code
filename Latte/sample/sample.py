...
def main(args):
    ...
    # Modified: Load custom VAE
     #Original: 
    vae = AutoencoderKL.from_pretrained(args.pretrained_model_path, subfolder="vae").to(device)
    #vae = WVAE_Compressed_TopK_multi_wavelet.from_pretrained(args.pretrained_model_path, subfolder="vae").to(device)
    vae.eval()
...
if __name__ == "__main__":
    ...
    parser.add_argument("--ckpt", type=str, default="/scratch/cs/vidgen/guanjr/project/latent_wf_vae_new/latte_checkpoint/Latte_checkpoint/ucf101.pt")
