...
FROM_PRETRAINED="/scratch/cs/vidgen/guanjr/experiment/WFVAE_Experiment/WVAE_Channel_Keepratio_0.5_no_teacher_loss_8_channels_fix_topk_32frame_8gpu-lr2.00e-05-bs4-rs256-sr1-fr32-cons0.0-p1_1200000-p2_0-modetv_l1-20251107_192656/checkpoint-290000.ckpt"
MODEL_CONFIG="/scratch/cs/vidgen/guanjr/project/latent_wf_vae_new/examples/WVAE_compressed_topk_multi_wavelet/wfvae-temporal-compressed-example-fix-topk-handcraft-8chan-keep-25.json"
...
export PYTHONPATH=/scratch/cs/vidgen/guanjr/project/WF-VAE:$PYTHONPATH
...
python scripts/eval_vae_psnr_fixed.py \
    ...
    --subset_size 2000 \
    --save_fps 8 \
    --paper_video_folder erase_25_8_webvid \
    --output_file results_all_metrics_8_webvid_25%.json
