...
FROM_PRETRAINED="/scratch/cs/vidgen/guanjr/experiment/WFVAE_Experiment/WFVAE-baseline-8chn-eval-33frames-10000save-lr2.00e-05-bs4-rs256-sr1-fr33/checkpoint-290000.ckpt"
MODEL_CONFIG="/scratch/cs/vidgen/guanjr/project/latent_wf_vae_new/examples/WVAE_compressed_topk_multi_wavelet/wfvae-temporal-compressed-example-fix-topk-handcraft-16chan-keep-25.json"
...
python scripts/eval_vae_psnr_fixed.py \
    ...
    --subset_size 2000 \
    --save_fps 8 \
    --paper_video_folder erase_25_16_webvid \
    --output_file results_all_metrics_16_webvid_25%.json
