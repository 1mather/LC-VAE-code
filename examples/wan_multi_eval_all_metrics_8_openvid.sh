...
FROM_PRETRAINED="/scratch/cs/vidgen/guanjr/experiment/wan2_1_vae_multi_wavelet/wan_multi_nocache-lr1.00e-05-bs2-rs256-sr1-fr33-cons0.0-p1_20000000-p2_0/checkpoint-100000.ckpt"
...
python scripts/eval_vae_psnr_fixed.py \
    ...
    --subset_size 2000 \
    --save_fps 8 \
    --paper_video_folder wan2_1_multi_results_all_metrics_8_openvid \
    --output_file wan2_1_multi_results_all_metrics_8_openvid.json
