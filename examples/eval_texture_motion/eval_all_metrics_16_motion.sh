...
REAL_VIDEO_DIR="/scratch/cs/vidgen/guanjr/UCF-101/HorseRace"
NUM_FRAMES=32
RESOLUTION=256
SAMPLE_RATE=1
BATCH_SIZE=10
...
# EVALUATION RESULTS
# ======================================================================
# Total videos evaluated: 124
# Total frames evaluated: 3968

# PSNR (↑):        34.0672 ± 3.4309
# SSIM (↑):        0.9435 ± 0.0172
# LPIPS (↓):       0.0194 ± 0.0055
# rFVD (↓):        177.6214
# Flickering (↓):  0.014591 ± 0.003992
...
python scripts/eval_vae_psnr_fixed.py \
    ...
    --subset_size 2000 \
    --save_fps 8 \
    --paper_video_folder motion_16 \
    --output_file motion_16.json
