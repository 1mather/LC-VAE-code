...
REAL_VIDEO_DIR="/scratch/cs/vidgen/guanjr/UCF-101/BoxingSpeedBag"
NUM_FRAMES=32
RESOLUTION=256
SAMPLE_RATE=1
BATCH_SIZE=10
...
# Total frames evaluated: 4288

# PSNR (↑):        36.7799 ± 2.3359
# SSIM (↑):        0.9622 ± 0.0083
# LPIPS (↓):       0.0142 ± 0.0034
# rFVD (↓):        112.7880
# Flickering (↓):  0.010279 ± 0.002068
...
python scripts/eval_vae_psnr_fixed.py \
    ...
    --subset_size 2000 \
    --save_fps 8 \
    --paper_video_folder texture_16 \
    --output_file texture_16.json
