...
torchrun \
    ...
    --model_config /scratch/cs/vidgen/guanjr/project/latent_wf_vae_new/examples/WVAE_compressed_topk_multi_wavelet/wfvae-temporal-compressed-example-fix-topk-handcraft-8chan-ttt.json \
    --resolution 256 \
    --num_frames 32 \
    --batch_size 4 \
    --lr 0.00002 \
