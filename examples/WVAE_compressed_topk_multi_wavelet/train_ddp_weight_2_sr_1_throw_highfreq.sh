...
EXP_NAME=WVAE_Channel_Keepratio_0.5_throw_highfreq
...
torchrun \
    ...
    --model_config /scratch/cs/vidgen/guanjr/project/latent_wf_vae_new/examples/WVAE_compressed_topk_multi_wavelet/wfvae-temporal-compressed-example-fix-topk-handcraft-throw.json \
    --resolution 256 \
    --num_frames 25 \
    --batch_size 2 \
    --lr 0.00001 \
