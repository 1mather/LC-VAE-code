...
EXP_NAME=WVAE_Channel_Keepratio_0.5_no_teacher_loss_16_channels_fix_topk_32frame_8gpu
...
torchrun \
    ...
    --model_config /scratch/cs/vidgen/guanjr/project/latent_wf_vae_new/examples/WVAE_compressed_topk_multi_wavelet/wfvae-temporal-compressed-example-fix-topk-handcraft-16chan.json \
    --resolution 256 \
    --num_frames 32 \
    --batch_size 4 \
    --lr 0.00002 \
    ...
    --resume_from_checkpoint /scratch/cs/vidgen/guanjr/experiment/WFVAE_Experiment/WVAE_Channel_Keepratio_0.5_no_teacher_loss_16_channels_fix_topk_32frame_8gpu-lr2.00e-05-bs4-rs256-sr1-fr32-cons0.0-p1_1200000-p2_0-modetv_l1-20251102_233243/checkpoint-210000.ckpt \
    --enable_three_phase \
