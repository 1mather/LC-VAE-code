...
torchrun \
    ...
    --model_name WVAE_Compressed_TopK_multi_wavelet_ttt \
    --model_config /scratch/cs/vidgen/guanjr/project/latent_wf_vae_new/examples/WVAE_compressed_topk_multi_wavelet/wfvae-temporal-compressed-example-fix-topk-handcraft-16chan-ttt.json \
    --resolution 256 \
    --num_frames 32 \
    --batch_size 4 \
    --lr 0.00002 \
    ...
    --ckpt_dir /scratch/cs/aaltoml/users/guanjr/experiment/vae-ttt \
    --enable_three_phase \
