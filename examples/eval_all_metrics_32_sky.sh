...
FROM_PRETRAINED="/scratch/cs/vidgen/guanjr/experiment/WFVAE_Experiment/WVAE_Channel_Keepratio_0.5_no_teacher_loss_32_channels_fix_topk_32frame_8gpu-lr2.00e-05-bs4-rs256-sr1-fr32-cons0.0-p1_1200000-p2_0-modetv_l1-20251110_173209/checkpoint-290000.ckpt"
...
REAL_VIDEO_DIR="/scratch/cs/vidgen/guanjr/project/WF-VAE/sky_train_gt_150_frames"
NUM_FRAMES=32
RESOLUTION=256
SAMPLE_RATE=1
BATCH_SIZE=10
...
python scripts/eval_vae_psnr_fixed.py \
    ...
    --subset_size 2000 \
    --save_fps 8 \
    --paper_video_folder paper_videos_32_sky \
    --output_file results_all_metrics_32_sky.json
